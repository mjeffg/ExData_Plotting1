...
#   minute-averaged voltage (in volt),  energy sub-metering No. 1 (in watt-hour of active energy),
#   household global minute-averaged reactive power (in kilowatt)
#   across 2 days (2/1/2007-2/2/2007)
# fourth plot
par(mfrow = c(2, 2))
plot(datetime, powerSubData$Global_active_power, type = "l", xlab = "", ylab = "Global Active Power")
plot(datetime, powerSubData$Voltage, type = "l", ylab = "Voltage")
plot(datetime, powerSubData$Sub_metering_1, type = "l", xlab = "",ylab = "Energy sub metering")
...
plot(datetime, powerSubData$Global_reactive_power, type = "l", ylab = "Global_reactive_power")
